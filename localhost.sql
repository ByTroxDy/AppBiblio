...
(123, NULL, 'lib', 'lib', 6, 'Benicarlo', '2023-06-03', NULL),
(321, NULL, 'mus', 'mus', 1, 'Benicarlo', '2023-06-03', NULL);
...
(1, 'socio1', 321, '2023-06-05', 0),
(4, 'socio1', 123, '2023-06-05', 15);
...
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `fk_comentarios_documentos1` FOREIGN KEY (`isbn`) REFERENCES `documentos` (`isbn`),
  ADD CONSTRAINT `fk_comentarios_usuarios1` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`usuario`);
...
CREATE DEFINER=`phpmyadmin`@`%` EVENT `actualizar_sancion_diaria` ON SCHEDULE EVERY 1 DAY STARTS '2023-06-05 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
  UPDATE usuarios
