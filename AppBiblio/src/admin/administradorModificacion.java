...
public class administradorModificacion extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					administradorModificacion frame = new administradorModificacion();
	 ...
	 * Create the frame.
	 */
	public administradorModificacion() {
	...
	private class Eixir extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			administradorMenu admin = new administradorMenu();
